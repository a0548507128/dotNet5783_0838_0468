        ...
        static void productMethod()
        {
            ...
            switch (choiceForProduct)
            {
                ...
                case 1://get all products
                    IEnumerable<ProductForList> listFromMethod = blVariable.Product.GetProductsList();
                ...
                case 2://get single product by id
                    {
                        ...
                        try
                        {
                            Console.WriteLine(blVariable.Product.GetProductDetailsManager(product.ID));
                        }
                        catch (Exception e)
                        {
                            Console.WriteLine(e);
                ...
                case 3://add
                    {
                        ...
                        {
                            case 0:
                                product1.Category = DO.Enums.Category.Rodents;
                                break;
                            case 1:
                                product1.Category = DO.Enums.Category.Reptiles;
                                break;
                            case 2:
                                product1.Category = DO.Enums.Category.CatsAndDogs;
                                break;
                            case 3:
                                product1.Category = DO.Enums.Category.Birds;
                                break;
                            case 4:
                                product1.Category = DO.Enums.Category.Fish;
                                break;
                        ...
                        try
                        {
                            blVariable.Product.AddProductManager(product);
                        }
                        catch (Exception e)
                        {
                            Console.WriteLine(e);
                ...
                case 4://delete
                    {
                        ...
                        try
                        {
                            blVariable.Product.DeleteProductManager(id);
                        }
                        catch (Exception e)
                        {
                            Console.WriteLine(e);
                ...
                case 5://update product
                    {
                        ...
                        try
                        {
                            product = blVariable.Product.GetProductDetailsManager(Id);
                        }
                        catch (Exception e)
                        {
                            Console.WriteLine(e);
                        ...
                        {
                            case 0:
                                product.Category = Enums.ECategory.Rodents;
                                break;
                            case 1:
                                product.Category = Enums.ECategory.Reptiles;
                                break;
                            case 2:
                                product.Category = Enums.ECategory.CatsAndDogs;
                                break;
                            case 3:
                                product.Category = Enums.ECategory.Birds;
                                break;
                            case 4:
                                product.Category = Enums.ECategory.Fish;
                                break;
                        ...
                        blVariable.Product.UpdateProductManager(product);
                ...
                case 1://add product to cart
                    {
                        ...
                        while (productID != 0)
                        {
                            ...
                            {
                                //ID=
                                Name = blVariable.Product.GetProductDetailsManager(product.ID).Name,//manager
                                ID = productId,
                                Price = blVariable.Product.GetProductDetailsManager(product.ID).Price,//manager
                                Amount = amount
                            };
                        ...
                        Console.WriteLine(blVariable.Cart.AddProduct(cart, productID));
                        break;
                    }
                case 2:
                    {
                        ...
                        while (productID != 0)
                        {
                            BO.OrderItem orderItem = new BO.OrderItem()
                            {
                                ...
                                Name = blVariable.Product.GetProductDetailsManager(product.ID).Name,
                                ID = productId,
                                Price = blVariable.Product.GetProductDetailsManager(product.ID).Price,
                                Amount = amount
                            };
                            cart.ItemList.ToList().Add(orderItem);
                            Console.WriteLine("enter product id and amount of items in cart,for finish enter 0");
                        ...
                        Console.WriteLine(blVariable.Cart.UpdateAmountProduct(cart, productID, newAmount));
                        break;
                    }
                case 3:
                    {
                        ...
                        while (productId != 0)
                        {
                            BO.OrderItem orderItem = new BO.OrderItem()
                            {
                                ...
                                Name = blVariable.Product.GetProductDetailsManager(productId).Name,
                                ID = productId,
                                Price = blVariable.Product.GetProductDetailsManager(product.ID).Price,
                                Amount = amount
                            };
        ...
        static void orderMethod()
        {
            ...
            switch (choiceForOrder)
            {
                case 1://get all orders
                    {
                        IEnumerable<OrderForList> listFromMethod = blVariable.Order.GetOrderList();
                ...
                case 3://update shipping order
                    {
                        ...
                        try
                        {
                            orderFromMethod = blVariable.Order.OrderShippingUpdate(parse);
                ...
                case 4:// update delivery order
                    {
                        ...
                        try
                        {
                            orderFromMethod = blVariable.Order.OrderDeliveryUpdate(parse);
                ...
                case 5://tracking order
                    {
                        ...
                        try
                        {
                            ...
                            orderTrackingFromMethod = blVariable.Order.OrderTracking(parse);
                            List<OrderTracking.StatusAndDate> listFromMethod = (List<OrderTracking.StatusAndDate>)orderTrackingFromMethod.listOfStatus;
